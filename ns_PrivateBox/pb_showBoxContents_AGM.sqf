/*
null = [_container] execVM "ns_PrivateBox\pb_showBoxContents_AGM.sqf";
...
_actions = ["Содержимое ящика:", localize "STR_AGM_Captives_CancelSelection"] call AGM_Interaction_fnc_prepareSelectMenu;
